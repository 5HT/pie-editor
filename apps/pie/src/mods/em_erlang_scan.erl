...
-file("src/mods/em_erlang_scan.xrl", 49).
...
-file("src/mods/em_erlang_scan.erl", 362).
yystate() -> 49.
...
yystate(51, [10|Ics], Line, Tlen, _, _) ->
    yystate(51, Ics, Line+1, Tlen+1, 22, Tlen);
...
yystate(35, [10|Ics], Line, Tlen, _, _) ->
    yystate(43, Ics, Line+1, Tlen+1, 5, Tlen);
...
yystate(12, [10|Ics], Line, Tlen, _, _) ->
    yystate(4, Ics, Line+1, Tlen+1, 6, Tlen);
...
yyaction(22, _, _, _) -> skip_token;
yyaction(23, _, _, _) ->
    yyaction_23();
yyaction(_, _, _, _) -> error.

-compile({inline,yyaction_0/2}).
-file("src/mods/em_erlang_scan.xrl", 10).
yyaction_0(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/mods/em_erlang_scan.xrl", 11).
yyaction_1(TokenChars, TokenLine) ->
     base (TokenLine, TokenChars) .

-compile({inline,yyaction_2/2}).
-file("src/mods/em_erlang_scan.xrl", 12).
yyaction_2(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("src/mods/em_erlang_scan.xrl", 13).
yyaction_3(TokenChars, TokenLine) ->
...
-file("src/mods/em_erlang_scan.xrl", 18).
yyaction_4(TokenChars, TokenLine) ->
     { token, { var, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("src/mods/em_erlang_scan.xrl", 21).
yyaction_5(TokenChars, TokenLine) ->
     S = lists : sublist (TokenChars, 2, length (TokenChars) - 2),
     { token, { string, TokenLine, string_gen (S) } } .

-compile({inline,yyaction_6/2}).
-file("src/mods/em_erlang_scan.xrl", 25).
yyaction_6(TokenChars, TokenLine) ->
     S = lists : sublist (TokenChars, 2, length (TokenChars) - 2),
     { token, { atom, TokenLine, list_to_atom (string_gen (S)) } } .

-compile({inline,yyaction_7/2}).
-file("src/mods/em_erlang_scan.xrl", 28).
yyaction_7(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, cc_convert (TokenChars) } } .

-compile({inline,yyaction_8/1}).
-file("src/mods/em_erlang_scan.xrl", 29).
yyaction_8(TokenLine) ->
     { token, { '->', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/mods/em_erlang_scan.xrl", 30).
yyaction_9(TokenLine) ->
     { token, { ':-', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/mods/em_erlang_scan.xrl", 31).
yyaction_10(TokenLine) ->
     { token, { '=/=', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("src/mods/em_erlang_scan.xrl", 32).
yyaction_11(TokenLine) ->
     { token, { '==', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("src/mods/em_erlang_scan.xrl", 33).
yyaction_12(TokenLine) ->
     { token, { '=:=', TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("src/mods/em_erlang_scan.xrl", 34).
yyaction_13(TokenLine) ->
     { token, { '/=', TokenLine } } .

-compile({inline,yyaction_14/1}).
-file("src/mods/em_erlang_scan.xrl", 35).
yyaction_14(TokenLine) ->
     { token, { '>=', TokenLine } } .

-compile({inline,yyaction_15/1}).
-file("src/mods/em_erlang_scan.xrl", 36).
yyaction_15(TokenLine) ->
     { token, { '=<', TokenLine } } .

-compile({inline,yyaction_16/1}).
-file("src/mods/em_erlang_scan.xrl", 37).
yyaction_16(TokenLine) ->
     { token, { '<=', TokenLine } } .

-compile({inline,yyaction_17/1}).
-file("src/mods/em_erlang_scan.xrl", 38).
yyaction_17(TokenLine) ->
     { token, { '++', TokenLine } } .

-compile({inline,yyaction_18/1}).
-file("src/mods/em_erlang_scan.xrl", 39).
yyaction_18(TokenLine) ->
     { token, { '--', TokenLine } } .

-compile({inline,yyaction_19/2}).
-file("src/mods/em_erlang_scan.xrl", 41).
yyaction_19(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_20/1}).
-file("src/mods/em_erlang_scan.xrl", 42).
yyaction_20(TokenLine) ->
     { end_token, { dot, TokenLine } } .

-compile({inline,yyaction_21/1}).
-file("src/mods/em_erlang_scan.xrl", 43).
yyaction_21(TokenLine) ->
     { end_token, { dot, TokenLine } } .

-compile({inline,yyaction_23/0}).
-file("src/mods/em_erlang_scan.xrl", 45).
yyaction_23() ->
     skip_token .
