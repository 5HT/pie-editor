...
-file("src/mods/em_test_scan.xrl", 13).
...
-file("src/mods/em_test_scan.erl", 276).
yystate() -> 2.
...
-file("src/mods/em_test_scan.xrl", 5).
yyaction_0(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/mods/em_test_scan.xrl", 6).
yyaction_1(TokenLine) ->
     { token, { '++', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/mods/em_test_scan.xrl", 7).
yyaction_2(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_3/0}).
-file("src/mods/em_test_scan.xrl", 8).
yyaction_3() ->
     skip_token .

-compile({inline,yyaction_4/2}).
-file("src/mods/em_test_scan.xrl", 9).
yyaction_4(TokenChars, TokenLine) ->
