...
bindings() -> [
    ...
    {"S-Fn-HOME", {edit_lib, beginning_of_line, []}},
    {"S-Fn-END",  {edit_lib, end_of_line, []}},
    {"SC-LEFT", {edit_lib, beginning_of_line, []}},
    {"SC-RIGHT",{edit_lib, end_of_line, []}},
    {"C-LEFT",  {edit_lib, beginning_of_line, []}},
    {"C-RIGHT", {edit_lib, end_of_line, []}},
    {"Fn-PGDN", {edit_lib, scroll_down, []}},
    {"Fn-PGUP", {edit_lib, scroll_up, []}},
    {"SA-DOWN", {edit_lib, scroll_down, []}},
    {"SA-UP",   {edit_lib, scroll_up, []}},
    {"SC-DOWN", {edit_lib, next_line, []}},
    {"SC-UP",   {edit_lib, previous_line, []}},
    {"SA-LEFT", {edit_lib, backward_word, []}},
    {"SA-RIGHT",{edit_lib, forward_word, []}},
    {"A-LEFT",  {edit_lib, backward_word, []}},
    {"A-RIGHT", {edit_lib, forward_word, []}},
    {"DEL",     {edit_lib, delete_char_forward, []}},
    {"DOWN",    {edit_lib, next_line, []}},
    {"UP",      {edit_lib, previous_line, []}},
    {"C-DOWN",  {edit_lib, next_line, []}},
    {"C-UP",    {edit_lib, previous_line, []}},
    {"LEFT",    {edit_lib, backward_char, []}},
    {"RIGHT",   {edit_lib, forward_char, []}},
    {"S-DOWN",  {edit_lib, next_line, []}},
    {"S-UP",    {edit_lib, previous_line, []}},
    {"S-LEFT",  {edit_lib, backward_char, []}},
    {"S-RIGHT", {edit_lib, forward_char, []}},
    %% Motion
...
cx_bindings() -> [
    ...
    {"e",   {em_erlang, erlang_mode, []}},
    {"d",   {edit_lib, buffer_cord_info, []}}
    ].

minibuffer_bindings() -> [
    % CUA
    {"Fn-PGUP", {edit_extended, history_move, [up]}},
    {"Fn-PGDN", {edit_extended, history_move, [down]}},
    % Completion
